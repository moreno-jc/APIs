...
export default function RickMortyApi() {
   ...
   const deferredQuery = useDeferredValue(query);
    ...
    return (
      ...
      <>
      <div className="rounded-2xl w-[80%] min-h-screen bg-[#00000070]  text-white lg:p-10 sm:p-4 md:p-4  text-center justify-center mx-auto">
          <div id="rickMorty" className="flex flex-col rounded-2xl text-white lg:p-10  sm:p-4 md:p-4 text-center">
            <Image 
          ...
          <div className="flex flex-col rounded-2xl text-white p-10 sm:p-4 text-center">
            <div>
